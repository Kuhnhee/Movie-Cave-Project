...
//         // const a = options.a
//         // const { commit , getters, a } = options
//         if (getters.isLoggedIn) {
//             router.push('/');
//         }
//         else {
...
//         }
//     },
    signup: ({ commit, getters, dispatch }, { username, email, password, passwordConfirmation }) => {
        commit('clearErrors')
        if (getters.isLoggedIn) {
            router.push('/');
        } else {
            ...
            if (!username) {
                ...
                if (password === passwordConfirmation) {
                    axios.post(HOST + '/api/v1/user/', {username, email, password})
                    .then(message => {
                        message
                        const credentials = {
                            username,
